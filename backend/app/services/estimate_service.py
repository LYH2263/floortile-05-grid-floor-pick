...
def run_estimate(
    ...
    pick_max = settings_repo.get_max_mode_default() if max_mode is None else bool(max_mode)
    calc = tile_count(
        room["length"], room["width"], tile["tile_l"], tile["tile_w"], waste, max_mode=pick_max
    )
